...
export function loanProductsSchema() {
  const loanTypes = [
    { name: "Personal Loan", desc: "Quick funds starting from 9.99% interest.", max: "₹1 Crore" },
    { name: "Business Loan", desc: "Funding for business growth starting from 12.00%.", max: "₹5 Crore" },
    { name: "Non-Salaried Loan", desc: "Get funding based on bank transactions and CIBIL score.", max: "₹10 Lakhs" },
    { name: "Home Loan", desc: "Buy your dream home with rates starting from 6.50%.", max: "₹15 Crore" },
    { name: "Education Loan", desc: "Collateral-free studies abroad up to ₹1.5 Crore.", max: "₹1.5 Crore" },
    { name: "Loan Against Property", desc: "Funding against residential or commercial properties.", max: "₹30 Crore" },
    { name: "Vehicle Loan", desc: "Finance new or used cars starting from 8.50%.", max: "₹1 Crore" }
  ];
  return loanTypes.map(loan => ({
    '@context': 'https://schema.org',
    '@type': 'LoanOrCredit',
    name: `${loan.name} | Get Credit`,
    ...
    offers: {
      '@type': 'Offer',
      priceCurrency: 'INR',
      description: `Loan limit up to ${loan.max}.`
    }
  }));
}
